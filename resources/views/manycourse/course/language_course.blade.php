...
<body>
  <div class="container">
      <h1>{{ $cat->where('categories_id', 4)->first()->categories_name }} Programps</h1>
      @foreach ($course->where('categories_id', 4) as $lang)
      <div class="course-details">
          <h2 class="course-name">{{ $lang->course_name }}</h2>
          <p class="description">{{ $lang->descriptions }}</p>
          <p class="instructor">Instructor: <span>{{ $instructor[$lang->instructors_code] }}</span></p>
      </div>
      @endforeach
  </div>
</body>
